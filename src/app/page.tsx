  ...
  return (
    <div className="bg-black h-screen w-screen overflow-hidden relative">
      ...
      <div className="p-4 md:p-10 relative z-10 grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6 max-w-6xl mx-auto min-h-[80vh] auto-rows-min md:grid-rows-3">
        {/* メインプロフィール - 大きなカード */}
        <div className="md:col-span-2 md:row-span-2 backdrop-blur xs-gray-900/20 rounded-3xl border border-gray-700/50 p-6 md:p-8 flex flex-col justify-center items-center text-center order-1">
          <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-gradient-to-br from-purple-400 to-pink-600 mb-4 md:mb-6 flex items-center justify-center text-white text-xl md:text-2xl font-bold">
            R
          </div>
        ...
        {/* スキル */}
        <div className="backdrop-blur-xs bg-gray-900/20 rounded-3xl border border-gray-700/50 p-4 md:p-6 order-2">
          <h3 className="text-white text-lg md:text-xl font-semibold mb-3 md:mb-4">💻 スキル</h3>
          <div className="space-y-1.5 md:space-y-2">
            <div className="text-blue-400 text-xs md:text-sm">React / Next.js</div>
            <div className="text-green-400 text-xs md:text-sm">Node.js / Express</div>
            <div className="text-yellow-400 text-xs md:text-sm">TypeScript</div>
            <div className="text-purple-400 text-xs md:text-sm">PostgreSQL</div>
          </div>
        </div>

        {/* 経験年数 */}
        <div className="backdrop-blur-xs bg-gray-900/20 rounded-3xl border border-gray-700/50 p-4 md:p-6 flex flex-col justify-center items-center order-3">
        ...
        {/* プロジェクト */}
        <div className="md:col-span-2 backdrop-blur-xs bg-gray-900/20 rounded-3xl border border-gray-700/50 p-4 md:p-6 order-5 md:order-4">
        ...
        {/* 連絡先 */}
        <div className="backdrop-blur-xs bg-gray-900/20 rounded-3xl border border-gray-700/50 p-4 md:p-6 flex flex-col justify-center items-center order-4 md:order-5">
